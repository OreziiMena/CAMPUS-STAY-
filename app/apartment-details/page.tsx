        ...
        <div className={`navlinks ${isMobileMenuOpen ? "active" : ""}`}>
          ...
          {user ? (
            <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
              <span className="welcome-user" style={{ fontFamily: "Poppins", fontWeight: "600", color: "rgb(2, 53, 28)", fontSize: "14px", whiteSpace: "nowrap" }}>
                Hi, {user.name ? user.name.split(" ")[0] : "Student"}
              </span>
              {user.role === "AGENT" ? (
                <Link href="/agent-dashboard" className="start-btn" style={{ padding: "8px 16px", fontSize: "14px", display: "inline-flex", alignItems: "center", justifyContent: "center" }}>
                  Dashboard
                </Link>
              ) : (
                <Link href="/explore" className="start-btn" style={{ padding: "8px 16px", fontSize: "14px", display: "inline-flex", alignItems: "center", justifyContent: "center" }}>
                  Explore
                </Link>
              )}
              <button onClick={handleLogout} className="start-btn" style={{ padding: "8px 16px", fontSize: "14px", background: "#962828", border: "none", cursor: "pointer", display: "inline-flex", alignItems: "center", justifyContent: "center" }}>
                Log out
              </button>
            </div>
          ) : (
