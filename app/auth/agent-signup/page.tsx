...
import { registerAgent, checkUsernameAvailable } from "@/app/actions/auth";
import "../signup.css";
              ...
              <form id="agent-signup-form" className="auth-form" onSubmit={handleSubmit}>
                <div className="input-group">
                  ...
                  <small className="helper-text">
                    <i className="fas fa-info-circle"></i> Please use your exact legal name for identity verification and trust building.
                  </small>
                </div>
                ...
                <div className="input-group">
                  <label htmlFor="address">Office / Business Address</label>
                  <input
                    type="text"
                    id="address"
